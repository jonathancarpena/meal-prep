...
const MobileMenu = () => {
  ...
  return (
    <div className={` ${mobileMenu ? 'translate-x-0 ' : 'translate-x-[100vw] bg-transparent text-transparent '} fixed  inset-0 transition-all ease-in-out duration-300   z-[200] h-screen w-screen bg-yellow-400 flex flex-col text-white `}>
