...
function OrderSidedrawer() {
    ...
    return (
        <>
            ...
            <div
                className={`${sideDrawer ? 'translate-y-0 sm:translate-x-0' : 'text-transparent bg-transparent translate-y-full sm:translate-x-full sm:translate-y-0'} transition-all ease-in-out duration-300 fixed inset-0 z-[150] `}
            >
