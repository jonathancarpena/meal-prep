  ...
  const PracticesContent = [
    {
      text: 'Low Calories',
      img: (
        <span className='flex justify-center items-center sm:h-[65px] text-white text-[35px]'>
          <BsArrowDown /> 500
        </span>
      ),
    },
  ...
  return (
    <div className='bg-neutral-100 relative z-10'>
      <div className='bg-yellow-400 w-[95%] lg:w-[90%] mx-auto rounded-t-3xl  z-[50] text-center py-24 flex flex-col justify-center items-center'>
        ...
        <ul className=' mt-12 lg:mt-0 grid grid-cols-2 gap-10 md:gap-5 md:grid-cols-4 lg:gap-20 lg:px-20'>
