    ...
    const CoreValueContent = [
        {
            ...
            img: <BsFillStarFill className='text-[3.5rem] sm:text-[5rem]' />
        },
        {
            text: 'great tasting flavor',
            img: <GiFireBowl className='text-[3.5rem] sm:text-[5rem]' />
        },
        {
            text: '100% customer satisfaction',
            img: <RiUserSmileLine className='text-[3.5rem] sm:text-[5rem]' />
        },
    ]
    return (
            ...
            <div className='bg-[#333333] relative sm:bottom-14 pt-[6rem] pb-14 rounded-t-[3rem] px-20'>
                ...
                <ul className='flex flex-col space-y-10 items-center justify-evenly w-full mt-16 sm:flex-row sm:space-y-0'>
                    {CoreValueContent.map((item) => (
                        <li key={item.text} className='flex flex-col space-y-5 items-center justify-center w-[170px] sm:w-[200px]'>
